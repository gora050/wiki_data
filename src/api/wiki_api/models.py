...
class Page(models.Model):
    ...
    page_wiki_id = models.CharField(max_length=250,unique=True)
...
class WikiUser(models.Model):
    wiki_user_id = models.CharField(max_length=250, unique=True, null=True)
    wiki_user_text = models.CharField(max_length=250)
